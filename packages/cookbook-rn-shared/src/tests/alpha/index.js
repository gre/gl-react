    ...
    return (
      <View>
        ...
        <Text style={{ padding: 10, fontStyle: "italic" }}>
          You should see a submarine surounded by blue. The top of the submarine should fade away. The submarine should be full RED. if it is PINK, there is a pre-multiplied alpha issue.
        </Text>
      </View>
    );
  }
